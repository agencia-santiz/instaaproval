...
-- Insert sample data
INSERT INTO clients (name, avatar_url, color) VALUES
  ('Brothers Filmes', 'https://images.unsplash.com/photo-1594909122845-11baa439b7bf?q=80&w=2070', '#C9A962'),
  ('Designers Papelée', 'https://images.unsplash.com/photo-1628155930542-3c7a64e2c833?q=80&w=1974', '#ec4899'),
  ('Asfer Química', 'https://images.unsplash.com/photo-1579373903781-fd5c0c30c4cd?q=80&w=1974', '#3b82f6');
...
SELECT 
  ...
  124,
  'Aquela luz de final de tarde que transforma o filme do seu casamento em uma obra de arte. ✨🎬',
  'Ver Portfólio'
...
SELECT 
  ...
  589,
  'Bastidores de uma captação em 4K. É assim que nós fazemos a mágica acontecer! 🎥🔥',
  ''
FROM clients c WHERE c.name = 'Brothers Filmes';
...
SELECT 
  ...
  45,
  'Nova identidade visual para nossa linha de convites premium. Papel com textura especial 300g. 💌',
  'Comprar agora'
FROM clients c WHERE c.name = 'Designers Papelée';